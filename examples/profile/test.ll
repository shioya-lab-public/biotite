...
L1:
  ...
  switch i64 %temp_42, label %Unreachable43 [ i64 66924, label %L4 i64 66916, label %L2 i64 66912, label %L7 i64 66920, label %L3 i64 66928, label %L5 i64 66932, label %L6 ]
Unreachable43:
  unreachable
L2:
...
L1:
  ...
  %temp_25 = sext i32 %temp_24 to i64
  store i64 %temp_25, i64* @reg.a5
  %temp_26 = load i64, i64* @reg.a5
  %temp_27 = trunc i64 %temp_26 to i32
  %temp_28 = add i32 %temp_27, 1
  %temp_29 = sext i32 %temp_28 to i64
  store i64 %temp_29, i64* @reg.a5
  %temp_30 = load i64, i64* @reg.s0
  %temp_31 = add i64 %temp_30, -20
  %temp_32 = getelementptr [10240 x i8], [10240 x i8]* @reg.stack, i8 0, i64 %temp_31
  %temp_33 = bitcast i8* %temp_32 to i32*
  %temp_34 = load i64, i64* @reg.a5
  %temp_35 = trunc i64 %temp_34 to i32
  store i32 %temp_35, i32* %temp_33
  br label %L2
L2:
  ...
  %temp_41 = sext i32 %temp_40 to i64
  store i64 %temp_41, i64* @reg.a5
  %temp_42 = load i64, i64* @reg.a5
  %temp_43 = trunc i64 %temp_42 to i32
  %temp_44 = sext i32 %temp_43 to i64
  store i64 %temp_44, i64* @reg.a4
  %temp_45 = shl i64 24414, 12
  store i64 %temp_45, i64* @reg.a5
  %temp_46 = load i64, i64* @reg.a5
  %temp_47 = add i64 %temp_46, 255
  store i64 %temp_47, i64* @reg.a5
  %temp_48 = load i64, i64* @reg.a5
  %temp_49 = load i64, i64* @reg.a4
  %temp_50 = icmp sge i64 %temp_48, %temp_49
  br i1 %temp_50, label %L1, label %L3
L3:
  store i64 0, i64* @reg.a5
  %temp_51 = load i64, i64* @reg.a5
  store i64 %temp_51, i64* @reg.a0
  %temp_52 = load i64, i64* @reg.sp
  %temp_53 = add i64 %temp_52, 24
  %temp_54 = getelementptr [10240 x i8], [10240 x i8]* @reg.stack, i8 0, i64 %temp_53
  %temp_55 = bitcast i8* %temp_54 to i64*
  %temp_56 = load i64, i64* %temp_55
  store i64 %temp_56, i64* @reg.ra
  %temp_57 = load i64, i64* @reg.sp
  %temp_58 = add i64 %temp_57, 16
  %temp_59 = getelementptr [10240 x i8], [10240 x i8]* @reg.stack, i8 0, i64 %temp_58
  %temp_60 = bitcast i8* %temp_59 to i64*
  %temp_61 = load i64, i64* %temp_60
  store i64 %temp_61, i64* @reg.s0
  %temp_62 = load i64, i64* @reg.sp
  %temp_63 = add i64 %temp_62, 32
  store i64 %temp_63, i64* @reg.sp
